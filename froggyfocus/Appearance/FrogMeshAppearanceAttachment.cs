...
public partial class FrogMeshAppearanceAttachment : AppearanceAttachment
{
    [Export]
    ...
    public override void SetPrimaryColor(Color color)
    {
        foreach (var mesh in meshes)
        {
            ...
            //mesh.PrimaryMaterial.SetShaderParameter("albedo1", color);
        }
    }
    ...
    public override void SetSecondaryColor(Color color)
    {
        foreach (var mesh in meshes)
        {
            ...
            //mesh.PrimaryMaterial.SetShaderParameter("albedo2", color);
        }
    }
}
