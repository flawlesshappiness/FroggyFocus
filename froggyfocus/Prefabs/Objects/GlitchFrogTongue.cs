...
public partial class GlitchFrogTongue : FrogTongue
{
    [Export]
    ...
    public override Coroutine AnimateTongueTowards(Vector3 position)
    {
        ...
        IEnumerator Cr()
        {
            ...
            for (int i = 0; i < steps; i++)
            {
                ...
                yield return new WaitForSeconds(duration_step);
            }
        }
    }

    public override Coroutine AnimateTongueBack()
    {
    ...
    public override void AttachToTongue(Node3D target)
    {
    ...
    public override void ClearTongueAttachement()
    {
